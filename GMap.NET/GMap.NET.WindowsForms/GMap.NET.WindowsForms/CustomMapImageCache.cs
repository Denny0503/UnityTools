...
{
    public class CustomMapImageCache : PureImageCache
    {
        string cache;
        string gtileCache;
        string dir;
        ...
        public static CustomMapImageCache Instance;

        public CustomMapImageCache()
        {
            Instance = this;

            CacheLocation = $@"{Directory.GetCurrentDirectory()}\gmapcache\{Path.DirectorySeparatorChar}";
        }

        public CustomMapImageCache(string cachePath)
        {
            Instance = this;
