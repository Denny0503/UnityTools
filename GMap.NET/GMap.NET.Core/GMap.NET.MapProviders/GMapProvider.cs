...
namespace GMap.NET.MapProviders
{
    ...
    public class GMapProviders
    {
      ...
      public static readonly OpenStreetMapSurferTerrainProvider OpenStreetMapSurferTerrain = OpenStreetMapSurferTerrainProvider.Instance;
        ...
        /// 高德，行政地图
        /// </summary>
        public static readonly AMapNormalMapProvider AMapNormalMap = AMapNormalMapProvider.Instance;

        /// <summary>
        /// 高德，卫星地图
        /// </summary>
        public static readonly AMapSatelliteMapProvider AMapSatelliteMap = AMapSatelliteMapProvider.Instance;

        /// <summary>
        /// 高德，卫星路网混合地图
        /// </summary>
        public static readonly AMapHybridMapProvider AMapHybridMap = AMapHybridMapProvider.Instance;
        ...
        /// 百度普通地图
        /// </summary>
        public static readonly BaiduOrdinaryMapProvider BaiduOrdinaryMap = BaiduOrdinaryMapProvider.Instance;
        /// <summary>
        /// 
        /// </summary>
    ...
    public abstract class GMapProvider
    {
      ...
      public static int TimeoutMs = 44 * 1000; 
        ...
        static string languageStr = "zh_CN";
        ...
        static LanguageType language = LanguageType.ChineseSimplified;
