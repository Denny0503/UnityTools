...
namespace GMap.NET.Uility
{
    public partial class CoordinateTransform
    {
        /// <summary>
        /// 圆周率
        /// </summary>
        ...
        const double LON_BOUNDARY_MIN = 72.004;
        const double LAT_BOUNDARY_MIN = 0.8293;
        const double LON_BOUNDARY_MAX = 137.8347;
        const double LAT_BOUNDARY_MAX = 55.8271;
        ...
        /// <returns></returns>
        static bool OutOfChina(double gpsLat, double gpsLng)
        {
        ...
        public static void WGS84_toG_CJ02(double wgsLat, double wgsLng, out double gcjLat, out double gcjLng)
        {
        ...
        {
            WGS84_toG_CJ02(gcjLat, gcjLng, out wgsLat, out wgsLng);
